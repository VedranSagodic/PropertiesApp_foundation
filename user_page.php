...
<html class="no-js" lang="en">
    <head profile="https://polaznik13.edunova.hr/app_foundation.hr/user_page.php">
      <link rel="icon" 
        type="image/png" 
          ...
          <thead>
            ...
            <tbody>
              ...
              <tr class="table-row">
                ...
                <td><?= $res->address; ?></td>
                <td>
                  <a class="button success" href="update.php?id=<?= $res->id ?>">Update</a>
                </td>
                <td>
                  <a class="button alert" href="delete.php?id=<?= $res->id ?>">Delete</a>
                </td>
              </tr>
            </tbody>
